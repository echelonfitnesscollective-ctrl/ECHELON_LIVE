const EFC_MANUAL_SECTIONS = [
    ...
    { id: 'overhaul-2026-07', tag: 'CHANGE LOG', title: 'SITE OVERHAUL — WHAT CHANGED', intro: 'A full site pass covering launch blockers, conversion, design, security, and compliance. Everything below is live in production. Keep this section until the next major update.', steps: [
        ...
        ['Stripe catalog reviewed and fixed', '12-Week pay-in-full copy corrected to match the $399 Stripe price (was showing $349). Removed a stray duplicate $59 price left on the Group Fitness product from initial setup.'],
        ...
        ['Group Fitness purchases now show up for you', 'Previously a $20 drop-in or $59/mo unlimited purchase completed in Stripe but left zero record anywhere in the Admin Console. The webhook now logs each one into website_leads (lead_type "Group fitness purchase") so it shows up in your leads list like any other inquiry.'],
