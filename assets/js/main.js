...
function installSharedFooter() {
    ...
    footer.innerHTML = `
        ...
        <div class="footer-partners"><span class="footer-partners-title">TRUSTED PARTNERS</span><div class="footer-partner-grid"><span class="partner-logo"><img src="${prefix}assets/images/Cashmir.jpg" alt="Cashmir"></span><a href="https://intentrev.net" target="_blank" rel="noopener" class="partner-logo"><img src="${prefix}assets/images/intent-logo-i1.svg" alt="Intent Revenue"></a><span class="partner-logo"><img src="${prefix}assets/images/Official CentralShine logo.PNG" alt="Central Shine"></span><a href="#" class="partner-logo"><img src="${prefix}assets/images/VL-Logo.png" alt="VL Body Lab"></a></div></div>
